...
export async function generatePreactHelloUI(projectDir) {
        ...
        <div className="main-content">
          ...
          <div className="card">
            ...
            <ul className="routes-list">
              {routes.map((route, i) => <li key={i}><span className="route-path">{route.path}</span><span className={\`route-method method-\${route.method.toLowerCase()}\`}>{route.method}</span></li>)}
            </ul>
          </div>
          <div className="card">
